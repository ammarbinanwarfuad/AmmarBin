  ...
  return (
    <div className="min-h-screen bg-background p-3 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-2xl md:text-4xl font-bold">Content Calendar</h1>
            ...
            <div className="overflow-x-auto -mx-2 md:mx-0">
              <div className="min-w-[320px] px-2 md:px-0">
                <div className="grid grid-cols-7 gap-1">
                  ...
                  {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
                    <div key={day} className="p-1 md:p-2 text-center font-semibold text-xs md:text-sm text-muted-foreground">
                      {day}
                    </div>
                  ))}
              ...
              {daysInMonth.map((day) => {
                ...
                return (
                  <div
                    key={day.toISOString()}
                    className={`aspect-square border rounded-lg p-1 md:p-2 hover:bg-accent transition-colors ${
              ...
              <div className="space-y-2">
                {blogs
                  ...
                  .map((blog) => (
                    <div
                      key={blog._id}
                      className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-0 p-3 border rounded-lg"
                    >
                      <div className="flex items-center gap-2 md:gap-3 min-w-0 flex-1">
                        <div className="text-xs md:text-sm text-muted-foreground w-16 md:w-24 flex-shrink-0">
                          {format(
                            blog.publishedDate
                              ? new Date(blog.publishedDate)
                              : new Date(blog.createdAt),
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="font-medium text-sm md:text-base truncate">{blog.title}</div>
